 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Name Polish <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="product_name_pl" class="form-control" required=""  value="{{ $products->product_name_pl }}">
     @error('product_name_pl')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Tags Polish <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_tags_pl" class="form-control" value="{{ $products->product_tags_pl }}" data-role="tagsinput" required="">
     @error('product_tags_pl')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size Polish <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_size_pl" class="form-control" value="{{ $products->product_size_pl }}" data-role="tagsinput" required="">
     @error('product_size_pl')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Color Polish <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_color_pl" class="form-control" value="{{ $products->product_color_pl }}" data-role="tagsinput" required="">
     @error('product_color_pl')
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_en" id="textarea" class="form-control" required Polishaceholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Short Description Polish <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_pl" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_pl !!}
	</textarea>
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Long Description Polish <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="long_descp_pl" rows="10" cols="80">
		{!! $products->long_descp_pl !!}
						</textarea>
	 		 </div>
		</div>
...
<!-- ///////////////// End Start Multiple Image Update Area ///////// -->
   ...
   <div class="card">
     <img src="{{ asset($products->product_thambnail) }}" class="card-img-top" style="height: 230px; width: 280px;">
     <div class="card-body">
